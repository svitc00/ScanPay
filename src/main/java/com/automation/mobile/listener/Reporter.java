...
import com.automation.mobile.listener.TestCucumberListener;
...
public class Reporter {
    ...
    public static ExtentHtmlReporter getExtentHtmlReport() {
        return TestCucumberListener.getExtentHtmlReport();
    }
    ...
    public static ExtentReports getExtentReport() {
        return TestCucumberListener.getExtentReport();
    }
    ...
    private static ExtentTest getCurrentStep() {
        return TestCucumberListener.stepTestThreadLocal.get();
    }

    private static ExtentTest getCurrentScenario() {
        return TestCucumberListener.scenarioThreadLocal.get();
    }
}
