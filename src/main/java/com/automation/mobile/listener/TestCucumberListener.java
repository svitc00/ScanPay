...
public class TestCucumberListener implements Reporter,  Formatter {
    ...
    public TestCucumberListener(File file) {
        file = new File(FileLocations.REPORT_DIRECTORY + "/MobileAutomationTestReport.html") ;
    ...
    public void result(Result result) {
        ...
        if (Result.PASSED.equals(result.getStatus())) {
            ...
            try {
                    com.automation.mobile.listener.Reporter.addScreenCaptureFromPath(
                            CommonUtil.captureScreenshot(AppiumDeviceManager.getDevice(), AppiumDriverManager.getDriver()));
            } catch (IOException e) {
                e.printStackTrace();
            }
